        ...
        <div id="übersichtMain" class="relative basis-1/2 shrink-0 target:scroll-mt-20">
          ...
          <div class="sm:rounded-lg">
            <table id="alphaMain" class="table-fixed w-full text-lg text-left text-gray-600 dark:text-gray-400">
              <thead class="text-xs text-gray-700 uppercase bg-ifz-medium-blue dark:bg-gray-700 dark:text-gray-400">
                <tr>
              ...
              <tbody>
                <xsl:for-each select="*">
                  <xsl:if test="not(contains(translate(name(), '_', ' '), 'D') or contains(translate(name(), '_', ' '), 'ZG'))">
                    <tr class="bg-slate-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-ifz-light-blue dark:hover:bg-gray-600">
            ...
            <table id="chronoMain" class="hidden table-fixed w-full text-lg text-left text-gray-600 dark:text-gray-400">
              ...
              <tbody>
                ...
                <tr class="bg-slate-50 h-7 dark:bg-gray-800 hover:bg-ifz-light-blue dark:hover:bg-gray-600"/>
                <tr class="bg-slate-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-ifz-light-blue dark:hover:bg-gray-600">
                ...
                <tr class="bg-slate-50 h-5 dark:bg-gray-800 hover:bg-ifz-light-blue dark:hover:bg-gray-600"/>
                <tr class="bg-slate-50 border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-ifz-light-blue dark:hover:bg-gray-600">
                  <td class="px-3 py-2 font-semibold text-gray-900 whitespace-nowrap dark:text-white"></td>
                ...
                <tr class="bg-slate-50 dark:bg-gray-800 hover:bg-ifz-light-blue dark:hover:bg-gray-600">
              ...
              <xsl:for-each select="*">
                <div class="relative mb-5 overflow-x-auto shadow-md rounded-lg">
                  <table class="table-fixed w-full text-md text-left text-gray-600 dark:text-gray-400">
                    ...
                    <thead class="text-gray-700 text-sm bg-ifz-medium-blue dark:bg-gray-700 dark:text-gray-400">
                      <tr>
    ...
    <div id="searchResults" class="max-w-[1750px] mx-auto items-center p-3 target:scroll-mt-20">
      ...
      <div id="searchResultsNotation" class="mb-5 hidden">
        ...
        <table id="searchResultsNotationTable" class="table-fixed w-full text-md text-left text-gray-600 dark:text-gray-400">
          <thead class="text-sm text-gray-700 bg-ifz-medium-blue dark:bg-gray-700 dark:text-gray-400">
            <tr>
              <th scope="col" class="px-3 py-2 w-4/12 md:w-3/24">Notation</th>
              <th scope="col" class="px-3 py-2">
                Benennung
